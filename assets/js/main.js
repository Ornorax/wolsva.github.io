...
var typed3 = new Typed('.type', {
  strings: ['Abonne toi à ma chaine youtube', 'Suis moi sur Twitter', 'Rejoint mon serveur discord', 'Suis moi sur instagram', 'Like toutes mes vidéos youtube', 'Regarde mon github', 'Suis moi sur TikTok'],
  typeSpeed: 90,
  showCursor: false,
  backSpeed: 0,
  smartBackspace: true,
